...
// KONFIGURASI SISTEM
// ==========================================
const URL_APPS_SCRIPT = "https://script.google.com/macros/s/AKfycbxqecQHMISrNizUZxCgJ7euI5h9Ht71RQWqXP4Fi6VPUtYazVo2dDkI798oboADmUYNQw/exec";

// Koordinat Kantor
const KANTOR_LAT = -5.300651890054125;
const KANTOR_LNG = 105.03454645519633;
const MAKSIMAL_RADIUS_METER = 30;
...
// ==========================================
// MODUL LOGIN (ULTRA-FAST VERIFICATION)
// ==========================================
dom.formLogin.addEventListener('submit', async (e) => {
    e.preventDefault();
    const nik = dom.inNik.value.trim();
    if (!nik) {
        dom.errLogin.innerText = "Masukkan NIK terlebih dahulu.";
...
function masukDashboard() {
    ...
    if (currentUser.role === 'SUPERADMIN') {
        ...
        // Tampilkan Sapaan beserta Nama dan NIK pada Dashboard Pegawai
        document.getElementById('emp-greeting-name').innerText = "Halo, " + currentUser.nama;
        document.getElementById('emp-greeting-nik').innerText = "NIK Anda: " + currentUser.nik;
...
// OPTIMASI: Render Tabel Pegawai Menggunakan Metode String Builder HTML (Sangat Cepat)
function renderTablePegawai() {
    ...
    tbody.innerHTML = dataPegawaiCache.map(d => {
...
// OPTIMASI: Render Tabel Laporan Menggunakan Metode String Builder HTML (Sangat Cepat)
function renderTableLaporan() {
    ...
    dataAbsensiCache.forEach((d, index) => {
        ...
        // Susun HTML untuk tabel aplikasi web
        htmlBody += `
        <tr class="hover:bg-slate-800/30 transition-colors">
    ...
    // Injeksi sekaligus (Jauh lebih cepat dari sebelumnya)
    tbody.innerHTML = htmlBody;
    pBody.innerHTML = printBody;
